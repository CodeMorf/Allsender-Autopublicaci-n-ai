...
import { retryFailedAutopublishPosts, verifyAutopublishCronKey } from '@/lib/marketing-autopublicar/service';
...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json(await retryFailedAutopublishPosts(teamId, limit));
}
