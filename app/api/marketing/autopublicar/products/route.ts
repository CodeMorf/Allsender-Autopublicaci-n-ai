...
import { listAutopublishProducts } from '@/lib/marketing-autopublicar/service';
...
export async function GET(request: NextRequest) {
  ...
  const data = await listAutopublishProducts(ctx.teamId, request.nextUrl.searchParams);
